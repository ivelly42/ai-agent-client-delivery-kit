# AI Agent Client Delivery Kit

Public discovery mirror for Agent Ops Command Center, a Notion and spreadsheet template pack for teams shipping AI-agent work with Codex, Claude Code, Cursor, and local agents.
...
- AI-agent agencies delivering client work
- Consultants using Codex, Claude Code, Cursor, or local agents
- Engineering teams that need proof before handoff
- Operators who need run logs, verification ledgers, prompt history, cost tracking, and delivery acceptance in one workspace
